...
void insertPosition(int x, int position);   // inserts an integer at a specific point in the list.
void print();      //prints all elements in the list
void reversePrint();   // prints all elements in list in reverse order
...
int main(void)
{
    ...
    while(choise != 0)
    {
        ...
        {
            printf("###### OPTION 3 #####\nGive a pair of number (x, y), x is the number to be inserted and y is the position in the list of insertion\n");
            int position;
            char done;
